...
# sed -i "" s/Demo-Info.plist/$PROJECT_NAME-Info.plist/g Demo.xcodeproj/project.pbxproj
# sed -i "" s/Demo-Dev-Info.plist/$PROJECT_NAME-Dev-Info.plist/g Demo.xcodeproj/project.pbxproj
# sed -i "" s/Demo-Debug-Info.plist/$PROJECT_NAME-Debug-Info.plist/g Demo.xcodeproj/project.pbxproj
# sed -i "" s/Demo-Prefix.pch/$PROJECT_NAME-Prefix.pch/g Demo.xcodeproj/project.pbxproj
